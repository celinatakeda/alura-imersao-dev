...
function validaCampo(jogador) {
    msg = '';
    if(jogador.nome == "") {
        msg += "Informe o nome do jogador";a        
        var msgValidacao = document.getElementById("msg-valida");
        msgValidacao.innerHTML = msg;        
    }

    if(jogador.vitorias == "") {
        msg += "Inforem o número de vitórias";
        var msgValidacao = document.getElementById("msg-valida");
        msgValidacao.innerHTML = msg; 
    }

    if(jogador.empates == "") {
        msg += "Informe o número de empates";
        var msgValidacao = document.getElementById("msg-valida");
        msgValidacao.innerHTML = msg; 
    } 

    if(jogador.derrotas == "") {
        msg += "Informe o número de derrotas";
        var msgValidacao = document.getElementById("msg-valida");
        msgValidacao.innerHTML = msg; 
    } 
